  ...
  return (
    <div className="App">
      <form onSubmit={handleSubmit}>
        <label>
          Token Address:
          <input type="text" name="tokenAddress" value={tokenAddress} onChange={handleChange} />
        </label>
        <br />
        <label>
          Chain ID:
          <input type="text" name="chainId" value={chainId} onChange={handleChange} />
        </label>
        <br />
        <label>
          Receiver Address:
          <input type="text" name="receiverAddress" value={receiverAddress} onChange={handleChange} />
        </label>
        <br />
        <label>
          Token Amount:
